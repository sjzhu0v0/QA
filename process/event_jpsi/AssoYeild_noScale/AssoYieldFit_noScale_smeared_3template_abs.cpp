...
void AssoYieldEtagap(TString path_input = "/home/szhu/work/alice/analysis/QA/test/"
  ...
  TFile* file_input_tf1_assoYield_lowMult = new TFile(path_input_tf1_assoYield_lowMult);
  TFile* file_input_tf1_assoYield_highMult = new TFile(path_input_tf1_assoYield_highMult);
  ...
  MHGroupTool<TH1D> g_tf1_assoYield_lowMult_input(file_input_tf1_assoYield_lowMult,
                                                  "mass_template_pt_%d", {var_PtV2Jpsi}, {1});
  MHGroupTool<TH1D> g_tf1_assoYield_highMult_input(file_input_tf1_assoYield_highMult,
                                                   "mass_template_pt_%d", {var_PtV2Jpsi}, {1});
  ...
  for (auto iPtV2 : indexAnyPtV2Jpsi) {
    ...
    auto signal_tf1_assoYield_lowMult = g_tf1_assoYield_lowMult_input.GetHist(vector<int>{iPtV2});
    auto signal_tf1_assoYield_highMult = g_tf1_assoYield_highMult_input.GetHist(vector<int>{iPtV2});
...
int main(int argc, char** argv) {
  ...
  TString path_input_assoYield_lowMult_tf1 = argc > 4 ? argv[4] : "";
  TString path_input_assoYield_highMult_tf1 = argc > 5 ? argv[5] : "";
