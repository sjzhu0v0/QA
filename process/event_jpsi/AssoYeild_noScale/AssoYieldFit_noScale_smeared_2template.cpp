...
void AssoYieldEtagap(
    ...
    TString path_input_tf1_assoYield = "",
...
int main(int argc, char **argv) {
  ...
  TString path_input_assoYield_tf1 = argc > 3 ? argv[3] : "";
  ...
  AssoYieldEtagap(path_input, path_input_mass,path_input_tf1,  path_input_assoYield_tf1, path_output,
                  path_pdf);
