...
void AssoYieldEtagap(
  ...
  MHGroupTool1D assoYield_sub(
      file_input, var_DeltaPhiUS.fName+ "_AssoYield_sub_DeltaEta_%d_ptV2_%d",
      {var_DeltaEtaUS, var_PtV2Jpsi}, {indexHistDeltaEtaUS, 1});
  MHGroupTool1D assoYield_low(
      file_input, var_DeltaPhiUS.fName+ "_AssoYield_low_DeltaEta_%d_ptV2_%d",
      {var_DeltaEtaUS, var_PtV2Jpsi}, {indexHistDeltaEtaUS, 1});
  MHGroupTool1D assoYield_high(
      file_input, var_DeltaPhiUS.fName+ "_AssoYield_high_DeltaEta_%d_ptV2_%d",
      {var_DeltaEtaUS, var_PtV2Jpsi}, {indexHistDeltaEtaUS, 1});
