...
void JpsiAsso(
    TString path_input_flowVecd = "../input.root", TString path_output = "output.root",
    int runNumber = 0, double threshold_bs = 1.,
  ...
  StrVar4Hist var_DeltaEtaUS("DeltaEtaUS", "#Delta#eta_{J/#psi, track}", "", 80, {-4., 4.});
...
#define obj2push_thnd(rdf2push, ...)                                                               \
  ...
  // ULong64_t totalSize = gRResultHandles[0].GetPtr<THnD>()->GetNbins() *
...
int main(int argc, char** argv) {
  ...
  JpsiAsso(path_input_flowVecd, path_output, runNumber, threshold_bs, path_calib, path_pileup);
