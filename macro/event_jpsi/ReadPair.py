...
def EventMixingReadingPair(path_input_flowVecd: str, path_output: str, path_config: str):
    ...
    file_flowVecd.Close()  # Close early to save memory
    ...
    rdf_base = RDF.RDataFrame(tree_input)
    rdf_AllVar = (
    ...
    for cut_name, cut_expr in cut_items:
        ...
        thnd_model = ROOT.THnDModel(
            hist_name, full_title,
            len(vec_var), nbins_list, edges_list
        )
