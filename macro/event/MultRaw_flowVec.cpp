...
void MultRaw(TString path_input = "../input.root", TString path_output = "output.root",
             int runNumber = 0) {
  TFile* file_event = TFile::Open(path_input);
  TFile* fOutput = new TFile(path_output, "RECREATE");

  TChain* tree_event = MRootIO::OpenChain(file_event, "O2dqflowvecd");
  TChain* tree_event_ext = MRootIO::OpenChain(file_event, "O2rctrawdq");
  ...
  //     {"fNumContrib_fMultTPC", "fNumContrib_fMultTPC;fNumContrib;fMultTPC;Counts", 300, 0, 300,
  //     300,
  //      0, 300},
  //     "fNumContrib", "fMultTPC"));
  // gRResultHandlesFast.push_back(rdf_fullTrigger.Histo2D(
  //     {"fMultNTracksPV_fMultTPC", "fMultNTracksPV_fMultTPC;fMultNTracksPV;fMultTPC;Counts", 150,
  //     0,
  //      150, 300, 0, 300},
