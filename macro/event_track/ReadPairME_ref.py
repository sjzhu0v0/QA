...
def declare_same_track_filter(cut_name: str) -> None:
    """Declare the isSameTrack filter function for a given cut."""
    ROOT.gInterpreter.Declare(
        f"""
...
def book_histogram_for_cut2(
    ...
    """Book histogram for non-same track pairs for a given cut."""
...
def process_cuts_and_book_histograms(
    ...
    for cut_name, cut_expr in cut_items:
        ...
        declare_same_track_filter(cut_name)
