...
void Ref_BS(TString path_input_flowVecd = "../input.root",
  ...
  auto df_all = df_idx
                    .Define("ref1_pt",
                            [](const RVec<float> &v, const RVec<int> &i) {
                              return Take(v, i);
                            },
                            {"fPTREF", "ref1_idx"})
                    .Define("ref1_eta",
  ...
  df_all.Snapshot("jpsi_ref_pairs", path_otput,
                  {
                      ...
                      "fSelection", "fHadronicRate", "ref1_pt", "ref1_eta",
                      "ref1_phi", "ref1_ITSChi2NCl", "ref1_TPCNClsCR", "ref1_TPCNClsFound",
                      "ref1_TPCChi2NCl", "ref1_TPCSignal", "ref1_nsig_el", "ref1_nsig_pi",
                      "ref1_nsig_pr", "ref2_pt", "ref2_eta", "ref2_phi",
                      "ref2_ITSChi2NCl", "ref2_TPCNClsCR", "ref2_TPCNClsFound", "ref2_TPCChi2NCl",
                      "ref2_TPCSignal", "ref2_nsig_el", "ref2_nsig_pi", "ref2_nsig_pr",
                  });
}
